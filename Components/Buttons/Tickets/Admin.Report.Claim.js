...
client.on("interactionCreate", async (interaction) => {
    ...
    if (interaction.customId == "officialCliam") {
        ...
        if (AdminRole0 && AdminRole1 && AdminRole2 ) {
            ...
            if (LogType) {
                ...
                LogMessage.setDescription(`${Config.Embed_Info.WarningEmote} | Hey! <@${interaction.user.id}>, adlı kişi tarafından **Yetkili Şikayet** ticket'ı claimlenildi! İşte Detaylar!`);
