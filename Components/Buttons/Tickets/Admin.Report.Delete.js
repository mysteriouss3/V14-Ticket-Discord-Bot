...
client.on("interactionCreate", async (interaction) => {
    ...
    if (interaction.customId == "officialClose") {
        ...
        if (AdminRole0 && AdminRole1 && AdminRole2 ) {
            ...
            CloseYes.setCustomId("OfficialCloseYes");
...
client.on("interactionCreate", async (interaction) => {
    ...
    if (!interaction.isButton()) return;
    if (interaction.customId == "OfficialCloseYes") {
        ...
        if (LogType) {
            ...
            if(!datas) {
                fs.writeFileSync(`./Logs/${TicketOwner.userTag}-Yetkili-${TicketNumber}.txt`, "Bu Ticket da hiç bir mesaj bulunamadı!");
            ...
            if(datas) {
                ...
                fs.writeFileSync(`./Logs/${TicketOwner.userTag}-Yetkili-${TicketNumber}.txt`, data);
