...
client.on("interactionCreate", async (interaction) => {
    ...
    if (interaction.customId == "officialOpen") {
        ...
        adminButton.setCustomId("officialCliam");
        ...
        closeButton.setCustomId("officialClose");
        ...
        const AdminRole = db.get(`Guild_${interaction.guild.id}.Role.Admin_Report_Role`);
        ...
        if (AdminRole0 && AdminRole1 && AdminRole2) {
            ...
            interaction.guild.channels.create({
                ...
                reason: `${interaction.user.username} Adlı kullanıcı tarafından Yetkili Şikayeti amacıyla açıldı`,
                ...
                OpenWarn.setDescription(`${Config.Embed_Info.SuccessEmote} | Hey! <@${interaction.user.id}>, Başarıyla **Yetkili Şikayet** ticketınız açıldı! <#${c.id}> Buraya basarak gidebilirsiniz!`);
                ...
                if (LogType) {
                    ...
                    LogMessage.setDescription(`${Config.Embed_Info.SuccessEmote} | Hey! <@${interaction.user.id}>, adlı kişi tarafından **Yetkili Şikayet** kategorisinde ticket açıldı! İşte Detaylar!`);
                    ...
                    const LogMessage = new Discord.EmbedBuilder();
                        ...
                        **・** Ticket Sebepi: \`Yetkili Şikayeti\``
                        );
                        LogMessage.setFooter({ text: `${Config.Embed_Info.FooterText}`, iconURL: `${Config.Embed_Info.FooterImage}` });
